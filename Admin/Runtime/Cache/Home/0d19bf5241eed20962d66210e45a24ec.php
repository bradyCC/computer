...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="panel-title">订单商品详情</div>
        </div>
        <table class="table table-hover table-bordered table-striped">
            ...
            <?php if(is_array($items)): $i = 0; $__LIST__ = $items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                    <td class="td_width"><?php echo ($item['id']); ?></td>
                    <td class="td_name"><?php echo ($item['itemname']); ?></a></td>
                    <td class="td_img"><img src="<?php echo ($item['img']); ?>" alt="" width="150" height="70"></td>
