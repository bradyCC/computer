...
<head>
    ...
    <link rel="stylesheet" href="/copyjd/Admin/Home/View/Public/css/Indent_index.css">
    <style>
...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="panel-title">查看订单</div>
        </div>
        <form action="/copyjd/admin.php/Home/Indent/delAll" method="post">
            <table class="table table-hover table-bordered table-striped">
                ...
                <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                        <td class="td_width"><?php echo ($i); ?></td>
                        <td class="td_num"><a href="/copyjd/admin.php/Home/Indent/detail/cls/Indent/number/<?php echo ($row['number']); ?>"><?php echo ($row['number']); ?></a></td>
                        <td><?php echo ($row['username']); ?></td>
                        <td><?php echo date('Y-m-d H:i:s',$row['time']);?></td>
                        <td><?php echo ($row['statusname']); ?></td>
                        <td><a href="/copyjd/admin.php/Home/Indent/address/cls/Indent/id/<?php echo ($row['contact_id']); ?>">收货地址</a></td>
                        <td><?php echo ($row['is_confirm']?"已确认":"未确认"); ?></td>
                        <td class="td_width"><input type="checkbox" name="del[]" value="<?php echo ($row['id']); ?>"></td>
                        <td class="td_width"><a href="/copyjd/admin.php/Home/Indent/save/cls/Indent/id/<?php echo ($row['id']); ?>" class="btn btn-success">修改</a></td>
                        <td class="td_width"><a href="/copyjd/admin.php/Home/Indent/delete/id/<?php echo ($row['id']); ?>" class="btn btn-danger del">删除</a></td>
