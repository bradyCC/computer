...
<head>
    ...
    <link rel="stylesheet" href="/copyjd/Admin/Home/View/Public/css/Status_index.css">
...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="panel-title">查看订单状态</div>
        </div>
        <form action="/copyjd/admin.php/Home/Status/delAll" method="post">
            <table class="table table-hover table-bordered table-striped">
                ...
                <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="td_width"><a href="/copyjd/admin.php/Home/Status/save/cls/Status/id/<?php echo ($row['id']); ?>" class="btn btn-success" disabled="">修改</a></td>
                        <td class="td_width"><a href="/copyjd/admin.php/Home/Status/delete/id/<?php echo ($row['id']); ?>" class="btn btn-danger del" disabled="">删除</a></td>
        ...
        <div class="panel-footer">
            ...
            <div class="button">
                <button class="btn btn-primary check_all" disabled>全选</button>
                <button class="btn btn-warning clear_all" disabled>取消</button>
                <button class="btn btn-danger del_all" disabled>删除</button>
            </div>
        </div>
    </div>
