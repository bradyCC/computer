    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <table class="table table-hover table-bordered table-striped">
                ...
                <?php if(is_array($addrs)): $i = 0; $__LIST__ = $addrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$addr): $mod = ($i % 2 );++$i;?><tr>
                        <td class="td_width"><?php echo ($i); ?></td>
                        <td class="td_num"><?php echo ($addr['name']); ?></a></td>
