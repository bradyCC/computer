...
<head>
    ...
    <link rel="stylesheet" href="/copyjd/Admin/Home/View/Public/css/Comment_index.css">
    <style>
        table tr td{
...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="panel-title">查看评论</div>
        </div>
        <form action="/copyjd/admin.php/Home/Comment/delAll" method="post">
            <table class="table table-hover table-bordered table-striped">
                ...
                <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="td_name"><?php echo ($row['username']); ?></td>
                        <td class="td_itname"><?php echo ($row['itemname']); ?></td>
                        <td class="td_itname"><?php echo ($row['content']); ?></td>
                        <td><?php echo date('Y-m-d H:i:s',$row['time']);?></td>
                        <td class="td_width"><input type="checkbox" name="del[]" value="<?php echo ($row['id']); ?>"></td>
                        <td class="td_width"><a href="/copyjd/admin.php/Home/Comment/delete/id/<?php echo ($row['id']); ?>" class="btn btn-danger del">删除</a></td>
