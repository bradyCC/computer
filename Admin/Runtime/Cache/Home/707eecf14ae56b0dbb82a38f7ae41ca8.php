...
<head>
    ...
    <link rel="stylesheet" href="/copyjd/Admin/Home/View/Public/css/Item_index.css">
    <style>
        table tr td{
...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="panel-title">查看商品</div>
        </div>
        <form action="/copyjd/admin.php/Home/Item/delAll" method="post">
            <table class="table table-hover table-bordered table-striped">
                ...
                <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="name"><?php echo ($row['itemname']); ?></td>
                        <td><img src="<?php echo ($row['img']); ?>" width="100" height="70" alt=""></td>
                        <td class="td_brand"><?php echo ($row['price']); ?></td>
                        <td class="td_width"><?php echo ($row['stock']); ?></td>
                        <td class="td_brand"><?php echo ($row['brandname']); ?></td>
                        <td class="td_width"><?php echo ($row['is_shelf']?"上架":"下架"); ?></td>
                        <td class="td_width"><input type="checkbox" name="del[]" value="<?php echo ($row['id']); ?>"></td>
                        <td class="td_width"><a href="/copyjd/admin.php/Home/Item/save/cls/Item/id/<?php echo ($row['id']); ?>" class="btn btn-success">修改</a></td>
                        <td class="td_width"><a href="/copyjd/admin.php/Home/Item/delete/id/<?php echo ($row['id']); ?>" class="btn btn-danger del">删除</a></td>
