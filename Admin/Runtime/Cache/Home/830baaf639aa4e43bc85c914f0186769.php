...
<div class="container">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="/copyjd/admin.php/Home/Class/insert" method="post" enctype='multipart/form-data'>
                <div class="form-group">
                    <label for="">分类：</label>
                    <input type="text" name="classname" class="form-control" required autofocus>
                </div>
                <div class="form-group">
