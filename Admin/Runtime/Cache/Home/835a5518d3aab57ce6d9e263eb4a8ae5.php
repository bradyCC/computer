...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="panel-title">修改订单</div>
        </div>
        <div class="panel-body">
            <form action="/copyjd/admin.php/Home/Indent/update" method="post" enctype='multipart/form-data'>
                <div class="form-group">
                    <label for="">订单号：</label>
                    <input type="text" name="number" class="form-control" value="<?php echo ($row['number']); ?>" disabled>
                </div>
                <div class="form-group">
                    <label for="">订单状态：</label>
                    <input type="text" name="status_id" class="form-control" value="<?php echo ($row['status_id']); ?>">
                </div>
