...
<div class="container">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="/copyjd/admin.php/Home/Brand/insert" method="post" enctype='multipart/form-data'>
                <div class="form-group">
                    <label for="">品牌：</label>
                    <input type="text" name="brandname" class="form-control" required autofocus>
                </div>
                <div class="form-group">
                    <label for="">分类：</label>
                    <input type="text" name="class_id" class="form-control" required autofocus>
                </div>
                <div class="form-group">
