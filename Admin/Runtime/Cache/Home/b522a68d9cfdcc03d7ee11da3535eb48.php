...
<head>
    ...
    <link rel="stylesheet" href="/copyjd/Admin/Home/View/Public/css/Class_index.css">
...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="panel-title">查看分类</div>
        </div>
        <form action="/copyjd/admin.php/Home/Class/delAll" method="post">
            <table class="table table-hover table-bordered table-striped">
                ...
                <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="td_width"><a href="/copyjd/admin.php/Home/Class/save/cls/Class/id/<?php echo ($row['id']); ?>" class="btn btn-success">修改</a></td>
                        <td class="td_width"><a href="/copyjd/admin.php/Home/Class/delete/id/<?php echo ($row['id']); ?>" class="btn btn-danger del">删除</a></td>
