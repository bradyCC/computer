...
<div class="container">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="/copyjd/admin.php/Home/Advert/insert" method="post">
                <div class="form-group">
                    <label for="">图片：</label>
                    <input type="text" name="img" class="form-control" value="<?php echo ($path); ?>" required autofocus>
                </div>
                <div class="form-group">
                    <label for="">位置：</label>
                    <input type="text" name="position" class="form-control" value="0" required>
                </div>
                <div class="form-group">
                    <label for="">URL地址：</label>
                    <input type="text" name="url" class="form-control" value="http://image.baidu.com" required>
                </div>
                <div class="form-group">
