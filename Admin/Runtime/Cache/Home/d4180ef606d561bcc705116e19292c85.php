...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="panel-title">添加订单状态</div>
        </div>
        <div class="panel-body">
            <form action="/copyjd/admin.php/Home/Status/insert" method="post">
                <div class="form-group">
                    <label for="">订单状态：</label>
                    <input type="text" name="statusname" class="form-control" required autofocus>
                </div>
                <div class="form-group">
