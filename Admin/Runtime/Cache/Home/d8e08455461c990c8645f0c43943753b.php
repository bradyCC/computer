...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="panel-title">添加商品</div>
        </div>
        <div class="panel-body">
            <form action="/copyjd/admin.php/Home/Item/insert" method="post">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="img" class="form-control" value="<?php echo ($path); ?>" required>
                </div>
                <div class="form-group">
                    <label for="">价格：</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="is_shelf" class="form-control" value="1" required>
                </div>
                <div class="form-group">
